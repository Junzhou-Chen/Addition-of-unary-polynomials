@[TOC](队列实现两个一元多项式的相加算法)

文章完整代码下载链接[https://github.com/BilboJunzhou/Addition-of-unary-polynomials](https://github.com/BilboJunzhou/Addition-of-unary-polynomials)
# 一元多项式节点定义
一元多项式的一般结构如下
$$
